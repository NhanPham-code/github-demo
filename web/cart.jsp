...
<html>
    ...
    <body>
        ...
        <header>
            <nav>
                ...
                <div class="others">
                    ...
                    <a id="cart" name="cart" value="cart" href="cart.jsp" class="badges" data-count="${requestScope.size}">
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="pCart" items="${requestScope.list}">
                    <tr>
                        <td><img src="${pCart.getProduct().getProImage()}" width="80px" height="80px"></td>
                        <td>${pCart.getProduct().getProName()}</td>
                        <td>${pCart.getQuantityTB()}</td>
                        <td>${pCart.getProduct().getPrice()}$</td>
                        <td><a href="deleteCart?id=${pCart.getProduct().getProductID()}">Delete Product</a></td>
                    </tr>
                </c:forEach>
                <tr class="total">
